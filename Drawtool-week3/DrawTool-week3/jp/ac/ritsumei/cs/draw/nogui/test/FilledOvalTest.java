/*
 * Test code for the class FilledOval
...
public class FilledOvalTest {
    
    @Test
    public void testFilledOval1() {
    ...
    private void check(Figure figure) {
        assertTrue(figure.getName().equals("FilledOval"));
